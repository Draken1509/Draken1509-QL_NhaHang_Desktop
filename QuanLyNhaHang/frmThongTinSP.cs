        ...
        private void gunaButton1_Click(object sender, EventArgs e)// button cập nhâtk
        {
            ...
            if (txt_giaBan.Text != "" && txt_tenSP.Text != "")
            {
                  if (txt_capnhatduongdan.Text != "")
                    {
                    string tenAnhBanDau = txt_anh.Text;
                    ...
                    string newFileName = tenAnhBanDau; // Tên anh
                ...
                int idMon = int.Parse(lbl_idmon.Text.Trim());
                ...
                int kt = monandal.updateMonAn(idMon, idLoai, tenMon, giaBan, ghichu);
                if (kt == 1)
                {
                    MessageBox.Show("Cập nhật thành công");
                    Application.OpenForms["frmThemSP"].Close();
